        ...
        builder.registerOwnModOptions()
            ...
            .addPage(builder.createOptionPage()
                ...
                .addOptionGroup(builder.createOptionGroup()
                    .setName(Component.translatable("overgreen.config.fog"))
                ...
                .addOptionGroup(builder.createOptionGroup()
                    .setName(Component.translatable("overgreen.config.fire_overlay"))
            ...
            .addPage(builder.createOptionPage()
                .setName(Component.translatable("overgreen.config.zoom"))
                .addOption(config.initialZoom.buildOption(builder, config, "initial_zoom", 40)
                    .setRange(15, 80, 1)
                    .setValueFormatter(FORMATTER_10))
                .addOption(config.zoomStep.buildOption(builder, config, "zoom_step", 15)
                    .setRange(10, 40, 1)
                    .setValueFormatter(FORMATTER_10))
                .addOption(config.zoomExpDecay.buildOption(builder, config, "zoom_exp_decay", 20)
                    .setRange(1, 40, 1)
                    .setValueFormatter(FORMATTER_20))
                .addOption(config.sensitivityReduction.buildOption(builder, config, "sensitivity_reduction", 10)
                    .setRange(0, 20, 1)
                    .setValueFormatter(FORMATTER_20)))
            .addPage(builder.createOptionPage()
